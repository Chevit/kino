...
@property (weak, readonly) NSMutableSet *floatings;
@property (unsafe_unretained, readonly) id <ZFloatingObject> activeFloating;
@property (weak, readonly) NSString *activeIdentifier;
